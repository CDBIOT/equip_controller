		...
		<h1>Energy</h1>
			<div>
				<table className = {styles.table}>
					<tr><th className = {styles.thead} colSpan={1}>TEMPERATURA DA SALA </th><th colSpan={4}>TEMPERATURAS </th></tr>
					<tr>
						<td id="m"> </td>
					...
					<td><button type="submit"> Cadastrar Temperatura</button></td>
				</table>
    			...
    			<td><button type="submit"> Listar dia</button></td>
